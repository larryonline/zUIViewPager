#
#  Be sure to run `pod spec lint zUIViewPager.podspec' to ensure this is a
...
improve list
  ...
  s.author             = { "ZhangZhenNan" => "larry.zzn@gmail.com" }
  # Or just: s.author    = "ZhangZhenNan"
  # s.authors            = { "ZhangZhenNan" => "larry.zzn@gmail.com" }
  # s.social_media_url   = "http://twitter.com/ZhangZhenNan"
  ...
  s.source_files  = "Classes", "zUIViewPager/**/*.{h,m}"
